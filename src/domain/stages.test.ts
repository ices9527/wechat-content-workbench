...
import { defaultStagePromptLabel, FUTURE_REQUIREMENT_STAGES, requirementStageSchema, REQUIREMENT_STAGES } from "./stages";

describe("stage definitions", () => {
  it("keeps supported requirement stages centralized", () => {
    expect(REQUIREMENT_STAGES).toEqual(["angle", "outline", "draft", "dbs", "pre_publish", "review"]);
