...
const ALLOWED_TRANSITIONS: Record<ArticleStatus, ArticleStatus[]> = {
  ...
  outline_generated: ["outline_review"],
  outline_review: ["draft_generated"],
  draft_generated: ["dbs_checking"],
  dbs_checking: ["revision_generated"],
  revision_generated: ["human_review", "dbs_checking"],
